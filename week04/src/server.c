    ...
    while (1)
    {
        ...
        if (FD_ISSET(master_sock_tcp_fd, &readfds))
        {
            ...
            while (1)
            {
                ...
                sprintf(result.data, "Hello, %s! Seems you were born in %d. Your TA on Networks is %s.\n", client_data->name, 2018 - client_data->age, client_data->group == 3 ? "Adam Zubair" : "Nikita Bogomazov");
